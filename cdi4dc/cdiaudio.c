...
void write_cdi_head_data_sector(FILE* cdi, int32_t data_sector_count) {
	unsigned char *buf;
	
	buf = (unsigned char *) malloc(sector2_size);
...
void write_audio_cdi_header(FILE *cdi, char* cdiname, char* volume_name, int32_t data_sector_count, int32_t total_cdi_space_used) {
