...
void write_cdi_header_data_data_sector(FILE* cdi, int32_t data_sector_count) {
	unsigned char *buf;
		
	buf = (unsigned char *) malloc(cdi_head_data_data_track_sector_size);
...
void write_cdi_header_data_data_sector_2(FILE* cdi, int32_t data_sector_count) {
	unsigned char *buf;
	int32_t header_track_lba;
	
	buf = (unsigned char *) malloc(cdi_head_data_data_track_2_sector_size);
